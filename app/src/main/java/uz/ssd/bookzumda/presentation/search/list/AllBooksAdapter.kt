package uz.ssd.bookzumda.presentation.search.list
...
class AllBooksAdapter(
...
) : RecyclerView.Adapter<AllBooksAdapter.VendorCategoryView>(), Filterable {
    ...
    private var filteredList: ArrayList<BooksEntity> = ArrayList()
